...
func Contact(data ContactData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section class=\"w-full bg-background border-b-2 border-foreground py-14 md:py-20\"><div class=\"max-w-6xl mx-auto px-4 sm:px-8\"><p class=\"text-xs font-black uppercase tracking-widest text-foreground mb-2\">Contact</p><h1 class=\"font-head text-5xl md:text-7xl font-black uppercase leading-none text-foreground mb-5\">")
			if templ_7745c5c3_Err != nil {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, ", with operator-only channels and diagnostics deliberately kept outside public UI.</p></div></section><div class=\"max-w-6xl mx-auto px-4 sm:px-8\"><section class=\"mb-12 bg-card border-2 border-foreground p-6 md:p-8 nb-shadow\"><div class=\"prose text-foreground max-w-none\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
